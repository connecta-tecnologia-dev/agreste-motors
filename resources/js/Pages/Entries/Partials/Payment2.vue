            ...
            <div class="flex flex-wrap gap-6 mt-4">
                <div class="w-60 flex flex-col gap-1">
                    ...
                    <div class="flex w-full gap-3 items-center">
                        <Multiselect class="w-full" placeholder="Tipo de Pagamento" v-model="form.paymentType"
                            @select="filterPayments" :searchable="true" :canClear="false" :options="paymentTypes" />
                    </div>
                </div>
                ...
                <div v-if="form.paymentType && payments.selected" class="w-48 flex flex-col gap-1">
