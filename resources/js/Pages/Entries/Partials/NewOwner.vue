...
<template>
    <div>
        <Multiselect v-if="optionsLoaded" ref="multiselect" placeholder="Proprietário" :searchable="true" :canClear="false" v-model="form.customer"
            :options="options" @select="(event) => { startCreateCustomer(); $emit('ownerSet', form.customer); }" />
