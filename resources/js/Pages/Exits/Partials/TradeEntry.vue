...
defineProps({
    title: {
        type: String,
        default: 'Adicionar Veículo de Entrada',
    },
    content: {
        type: String,
        default: '',
...
const emit = defineEmits(['addEntryVehicle']);
...
const returnData = () => {
    emit('addEntryVehicle', { data: vehicles.selected, mileage: form.mileage, clerks: form.clerks, value: form.value, addition: form.addition, services: form.services });
    closeModal();
};
