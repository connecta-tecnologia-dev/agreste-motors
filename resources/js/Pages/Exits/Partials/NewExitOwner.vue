...
watchEffect(() => {
    if ((!props.isDisabled || props.owner != form.customer)) {
        reload();
    } else {
        form.customer = null;
    }
...
<template>
    <div>
        <Multiselect v-if="optionsLoaded" ref="multiselect" placeholder="Novo Proprietário" :searchable="true" :canClear="false"
        ...
        <Multiselect v-else placeholder="Novo Proprietário" :disabled="true" />
