    ...
    <ActionSection>
        ...
        <template #content>
            <h3 v-if="twoFactorEnabled && ! confirming" class="text-lg font-medium text-gray-900">
                Você não possui a autenticação de dois fatores ativa.
            </h3>

            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-gray-900">
                Complete a ativação da autenticação de dois fatores.
            </h3>
            ...
            <div class="mt-3 max-w-xl text-sm text-gray-600">
                <p>
                    Quando a autenticação de dois fatores está habilitada, você será solicitado a fornecer um token seguro e aleatório durante a autenticação. Você pode obter esse token por meio do aplicativo Google Authenticator do seu telefone.
                </p>
            </div>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        ...
                        <p v-else>
                            A autenticação de dois fatores está agora habilitada. Escaneie o seguinte código QR usando o aplicativo autenticador do seu telefone ou insira a chave de configuração.
                        </p>
                    </div>
