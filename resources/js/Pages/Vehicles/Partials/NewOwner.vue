...
const loadCustomers = async () => {
    try {
        ...
        response.data.forEach(customer => {
            options.push({
                value: customer.id,
                label: customer.name + ", CPF: " + customer.cpf
            });
        });
...
<template>
    <div>
        ...
        <div v-else>Carregando opções...</div>
        ...
        <DialogModal :show="createCustomer" @close="closeModal">
            ...
            <template #content>
                ...
                <div class="flex flex-wrap gap-3 mt-4">
                    ...
                    <div class="w-52">
                        <TextInput ref="cpfInput" v-model="form.cpf" type="text" class="mt-1 block w-full" placeholder="CPF/CNPJ" v-maska data-maska="['###.###.###-##', '##.###.###/####-##']" />
